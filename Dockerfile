...
RUN dotnet build "DiyanetNamazVakti.Api/DiyanetNamazVakti.Api.csproj" -c Release -o /app/build

# Publish
FROM build AS publish
RUN dotnet publish "DiyanetNamazVakti.Api/DiyanetNamazVakti.Api.csproj" -c Release -o /app/publish
